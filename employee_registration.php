...
<div class="container-fluid" id="gradient-developer">
	<div class="row">
				...
				<label id="label-heading">CREATE ACCOUNT</label>
					...
					<form method="post" onsubmit="return passwordCheck()">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="unit" placeholder="Enter your unit name" name="unit">
						</div>
						<div class="form-group">
							<label for="address">Enter Address</label>
							<textarea class="form-control" rows="5" id="address" placeholder="Enter your address." name="address"></textarea>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<textarea class="form-control" rows="5" id="skills" placeholder="Enter Skills each separated with a comma." name="skills"></textarea>
						</div>
						
						<div id="label-login">
						<button class="btn btn-outline-dark" type="submit" id="submit" name="submit" >Register</button>
						<p id="login-label">Already have an account?<a href="developerLogin.php" style="text-decoration:none;"> Login Here</a></p>
					</div>
...
<div class="col-md-3"></div>
   ...
   if (isset($_POST["submit"])) {
   	...
   	if ($_POST['name'] != null && $_POST['contact'] != null && $_POST['address'] != null && $_POST['cnic'] != null && $_POST['email'] != null && $_POST['pwd'] != null && $_POST['skills'] != null) {
...
if(mysqli_num_rows($res_e) > 0){
	echo '<script language="javascript">';
   	...
   	$query = "INSERT INTO employee (emp_id, m_id, fullName, contact, address, cnic, email, password, skills) VALUES ('','','$_POST[name]','$_POST[contact]','$_POST[address]', '$_POST[cnic]','$_POST[email]','$_POST[pwd]','$_POST[skills]')";
