...
$developer = $_SESSION['loginsession'];

	$query = "SELECT * from employee where email = '$developer'";
			...
			<div class="card-body text-secondary ">
					<form method="post" onsubmit="return passwordCheck()">
						...
						<div class="form-group">
							...
							<input type="text" maxlength="15" class="form-control" id="cnic" name="cnic" value=<?php echo $row['cnic'];?>>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<textarea  class="form-control" rows="5" id="skills" name="skills" ><?php echo trim($row['skills']); ?> </textarea>
						</div>
...
$email = $_POST['email'];
$sql_e = "SELECT * FROM employee WHERE email = '$email' AND email !='$developer'";
...
if(mysqli_num_rows($res_e) > 0){
	...
	if ($_POST['name'] != "" && $_POST['contact'] != "" && $_POST['address'] != "" && $_POST['cnic'] != "" && $_POST['email'] != "" && $_POST['pwd'] != "" && $_POST['skills'] != "") {



	$sql = "UPDATE employee SET fullName= '$_POST[name]',contact= '$_POST[contact]',address= '$_POST[address]',cnic= '$_POST[cnic]',email= '$_POST[email]',password= '$_POST[pwd]',skills= '$_POST[skills]' WHERE emp_id = $devID";
...
$messageToQuery = "UPDATE managermessage SET m_to = '$_POST[email]' WHERE m_to = '$developer'";

$mQ = $conn->query($messageToQuery);


$messageFromQuery = "UPDATE managermessage SET m_from = '$_POST[email]' WHERE m_from = '$developer'";
